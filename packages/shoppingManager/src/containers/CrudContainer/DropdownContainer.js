...
export default class DropdownContainer extends PureComponent {
  ...
  static defaultProps = {
    ...defaultProps,
    onRenderDropdownForm: (props, container) => <DefaultDropdownForm {...props} container={container} />,
    onRenderDropdownList: (props, container) => <DefaultDropdownList {...props} container={container} />,
    onRenderDropdownTrigger: (props, container) => <DefaultDropdownTrigger {...props} container={container} />,
  }
